...
var AndroidRules []engine.Rule = []engine.Rule{
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`\.crypto\.Cipher`, 0), regexp2.MustCompile(`Cipher\.getInstance\(\s*"RSA/.+/NoPadding`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`\.crypto\.Cipher`)},
	// 	CWE:           "CWE-780",
	// 	AverageCVSS:   5.9,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`\.crypto\.Cipher`, 0), regexp2.MustCompile(`Cipher\.getInstance\(`, 0), regexp2.MustCompile(`"DES"`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`\.crypto\.Cipher`)},
	// 	CWE:           "CWE-327",
	// 	AverageCVSS:   5.9,
	...
	// Rule{
	// 	Or:            []*regexp2.Regexp{regexp2.MustCompile(`MODE_WORLD_WRITABLE|Context\.MODE_WORLD_WRITABLE`, 0), regexp2.MustCompile(`openFileOutput\(\s*".+"\s*,\s*2\s*\)`)},
	// 	CWE:           "CWE-276",
	// 	AverageCVSS:   6,
	...
	// Rule{
	// 	ExactMatch:    regexp2.MustCompile(`openFileOutput\(\s*".+"\s*,\s*3\s*\)`, 0),
	// 	CWE:           "CWE-276",
	// 	AverageCVSS:   6,
	...
	// Rule{
	// 	ExactMatch:    regexp2.MustCompile(`MessageDigest\.getInstance\("*MD5"*\)|MessageDigest\.getInstance\("*md5"*\)|DigestUtils\.md5\(`, 0),
	// 	CWE:           "CWE-327",
	// 	AverageCVSS:   7.4,
	...
	// Rule{
	// 	ExactMatch:    regexp2.MustCompile(`getInstance("md4")|getInstance("rc2")|getInstance("rc4")|getInstance("RC4")|getInstance("RC2")|getInstance("MD4")`, 0),
	// 	CWE:           "CWE-327",
	// 	AverageCVSS:   7.4,
	...
	// Rule{
	// 	Or:            []*regexp2.Regexp{regexp2.MustCompile(`.getExternalStorage`, 0), regexp2.MustCompile(`.getExternalFilesDir\(`)},
	// 	CWE:           "CWE-276",
	// 	AverageCVSS:   5.5,
	...
	// Rule{
	// 	ExactMatch:    regexp2.MustCompile(`\.createTempFile\(`, 0),
	// 	CWE:           "CWE-276",
	// 	AverageCVSS:   5.5,
	...
	// Rule{
	// 	Or:            []*regexp2.Regexp{regexp2.MustCompile(`0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00`, 0), regexp2.MustCompile(`0x01,0x02,0x03,0x04,0x05,0x06,0x07`)},
	// 	CWE:           "CWE-329",
	// 	AverageCVSS:   9.8,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`onReceivedSslError\(WebView`, 0), regexp2.MustCompile(`\.proceed\(\);`, 0), regexp2.MustCompile(`webkit\.WebView`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`webkit\.WebView`)},
	// 	CWE:           "CWE-295",
	// 	AverageCVSS:   7.4,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`android\.database\.sqlite`, 0), regexp2.MustCompile(`execSQL\(|rawQuery\(`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`android\.database\.sqlite`)},
	// 	CWE:           "CWE-89",
	// 	AverageCVSS:   5.9,
	...
	// Rule{
	// 	ExactMatch:    regexp2.MustCompile(`SQLiteOpenHelper\.getWritableDatabase\(`, 0),
	// 	CWE:           "CWE-312",
	// 	AverageCVSS:   1,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`android\.app\.DownloadManager`, 0), regexp2.MustCompile(`getSystemService\(DOWNLOAD_SERVICE\)`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`android\.app\.DownloadManager`)},
	// 	CWE:           "CWE-494",
	// 	AverageCVSS:   7.5,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`\.setWebContentsDebuggingEnabled\(true\)`, 0), regexp2.MustCompile(`webkit\.WebView`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`webkit\.WebView`)},
	// 	CWE:           "CWE-215",
	// 	AverageCVSS:   5.4,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`webkit\.WebView`, 0), regexp2.MustCompile(`(setJavaScriptEnabled\(true\))|(.addJavascriptInterface\()`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`webkit\.WebView`)},
	// 	CWE:           "CWE-749",
	// 	AverageCVSS:   8.8,
	...
	// Rule{
	// 	Or:            []*regexp2.Regexp{regexp2.MustCompile(`content\.ClipboardManager`, 0), regexp2.MustCompile(`CLIPBOARD_SERVICE`, 0), regexp2.MustCompile(`ClipboardManager`)},
	// 	CWE:           "CWE-200",
	// 	AverageCVSS:   5,
	...
	// Rule{
	// 	Or:            []*regexp2.Regexp{regexp2.MustCompile(`net\.JarURLConnection`, 0), regexp2.MustCompile(`JarURLConnection`, 0), regexp2.MustCompile(`jar:((?:http|https)://(?:[\w_-]+(?:(?:\.[\w_-]+)+))(?:[\w.,@?^=%&:/~+#-]*[\w@?^=%&/~+#-])?)`)},
	// 	CWE:           "CWE-611",
	// 	AverageCVSS:   5,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`\.crypto\.Cipher`, 0), regexp2.MustCompile(`Cipher\.getInstance\(`, 0), regexp2.MustCompile(`"AES"`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`\.crypto\.Cipher`)},
	// 	CWE:           "CWE-326",
	// 	AverageCVSS:   5,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`\.net\.ssl`, 0), regexp2.MustCompile(`TrustAllSSLSocket-Factory|AllTrustSSLSocketFactory|NonValidatingSSLSocketFactory|net\.SSLCertificateSocketFactory|ALLOW_ALL_HOSTNAME_VERIFIER|\.setDefaultHostnameVerifier\(|NullHostnameVerifier\(`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`\.net\.ssl`)},
	// 	CWE:           "CWE-295",
	// 	AverageCVSS:   7.4,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`\.loadUrl\(`, 0), regexp2.MustCompile(`webkit\.WebView`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`webkit\.WebView`)},
	// 	CWE:           "CWE-919",
	// 	AverageCVSS:   5,
	...
	// Rule{
	// 	Or:            []*regexp2.Regexp{regexp2.MustCompile(`MODE_WORLD_READABLE|Context\.MODE_WORLD_READABLE`, 0), regexp2.MustCompile(`openFileOutput\(\s*".+"\s*,\s*1\s*\)`)},
	// 	CWE:           "CWE-276",
	// 	AverageCVSS:   4,
	// 	Description:   "The file is 'World Readable'. Any application can read the file.",
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`\.crypto\.Cipher`, 0), regexp2.MustCompile(`Cipher\.getInstance\(`, 0), regexp2.MustCompile(`"ECB"`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`\.crypto\.Cipher`)},
	// 	CWE:           "CWE-327",
	// 	AverageCVSS:   5.9,
	...
	// Rule{
	// 	ExactMatch:    regexp2.MustCompile(`Runtime\.getRuntime\(`, 0),
	// 	CWE:           "CWE-78",
	// 	AverageCVSS:   9,
	...
	// Rule{
	// 	ExactMatch:    regexp2.MustCompile(`setVisibility\(View\.GONE\)|setVisibility\(View\.INVISIBLE\)`, 0),
	// 	CWE:           "CWE-919",
	// 	AverageCVSS:   4.3,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`dalvik\.system\.PathClassLoader|dalvik\.system\.DexFile|dalvik\.system\.DexPathList|dalvik\.system\.DexClassLoader|java\.security\.ClassLoader|java\.net\.URLClassLoader|java\.security\.SecureClassLoader`, 0), regexp2.MustCompile(`loadDex|loadClass|DexClassLoader|loadDexFile`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`dalvik\.system\.PathClassLoader|dalvik\.system\.DexFile|dalvik\.system\.DexPathList|dalvik\.system\.DexClassLoader|java\.security\.ClassLoader|java\.net\.URLClassLoader|java\.security\.SecureClassLoader`)},
	// 	CWE:           "CWE-695",
	// 	AverageCVSS:   4,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`com\.fasterxml\.jackson\.databind\.ObjectMapper`, 0), regexp2.MustCompile(`\.enableDefaultTyping\(`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`com\.fasterxml\.jackson\.databind\.ObjectMapper`)},
	// 	CWE:           "CWE-502",
	// 	AverageCVSS:   7.5,
	...
	// Rule{
	// 	ExactMatch:    regexp2.MustCompile(`MODE_PRIVATE|Context\.MODE_PRIVATE`, 0),
	// 	CWE:           "CWE-919",
	// 	AverageCVSS:   5,
	...
	// Rule{
	// 	Or:            []*regexp2.Regexp{regexp2.MustCompile(`com\.noshufou\.android\.su`, 0), regexp2.MustCompile(`com\.thirdparty\.superuser`, 0), regexp2.MustCompile(`eu\.chainfire\.supersu`, 0), regexp2.MustCompile(`com\.koushikdutta\.superuser`, 0), regexp2.MustCompile(`eu\.chainfire\.`)},
	// 	CWE:           "CWE-250",
	// 	AverageCVSS:   7.5,
	...
	// Rule{
	// 	And:           []*regexp2.Regexp{regexp2.MustCompile(`WebView`, 0), regexp2.MustCompile(`loadData\(`, 0), regexp2.MustCompile(`android\.webkit`)},
	// 	NotOr:         []*regexp2.Regexp{regexp2.MustCompile(`WebView`, 0), regexp2.MustCompile(`android\.webkit`)},
	// 	CWE:           "CWE-749",
	// 	AverageCVSS:   8,
	...
	// Rule{
	// 	ExactMatch:    regexp2.MustCompile(`Log\.(v|d|i|w|e|f|s)|System\.out\.print|System\.err\.print`, 0),
	// 	CWE:           "CWE-532",
	// 	AverageCVSS:   3.2,
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`java\.util\.Random`, 0), regexp2.MustCompile(`Random\(\)`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`java\.util\.Random`)},
	// 	CWE:           "CWE-330",
	// 	AverageCVSS:   1,
	...
	// Rule{
	// 	ExactMatch:    regexp2.MustCompile(`Random\..*\(.*\)|Random\(.*\)|\(.*\).random\(\)`, 0),
	// 	CWE:           "CWE-330",
	// 	AverageCVSS:   1,
	// 	Description:   "The application uses a predictable, therefore insecure, random number generator.",
	// 	Recomendation: "Instances of java.util.Random are not cryptographically secure. Consider instead using SecureRandom to get a cryptographically secure pseudo-random number generator for use by security-sensitive applications. https://docs.oracle.com/javase/8/docs/api/java/util/Random.html",
	...
	// Rule{
	// 	And: []*regexp2.Regexp{regexp2.MustCompile(`\.crypto\.Cipher`, 0), regexp2.MustCompile(`Cipher\.getInstance\(`, 0), regexp2.MustCompile(`"GCM"`)}, NotAnd: []*regexp2.Regexp{regexp2.MustCompile(`\.crypto\.Cipher`)},
	// 	CWE:           "CWE-326",
	// 	AverageCVSS:   2,
	...
	// Rule{
	// 	ExactMatch:    regexp2.MustCompile(`MessageDigest\.getInstance\("*SHA-1"*\)|MessageDigest\.getInstance\("*sha-1"*\)|DigestUtils\.sha\(`, 0),
	// 	CWE:           "CWE-327",
	// 	AverageCVSS:   5.9,
